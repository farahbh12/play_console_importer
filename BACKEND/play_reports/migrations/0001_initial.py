# Generated by Django 5.2.1 on 2025-08-31 22:20
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role_client', models.CharField(choices=[('Owner', 'Owner'), ('MEMBRE_INVITE', 'Membre Invité')], default='Owner', max_length=20)),
                ('status', models.CharField(choices=[('ACTIVE', 'Actif'), ('INVITED', 'Invité'), ('INACTIVE', 'Inactif')], default='ACTIVE', max_length=20)),
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('updated_at', models.DateTimeField(auto_now=True)),
                ...
                ('invited_by', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='invited_clients', to=settings.AUTH_USER_MODEL)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(choices=[('PENDING', 'En attente'), ('ACCEPTED', 'Acceptée'), ('REVOKED', 'Révoquée'), ('EXPIRED', 'Expirée')], default='PENDING', max_length=10, verbose_name='Statut')),
                ('created_at', models.DateTimeField(auto_now_add=True, verbose_name='Date de création')),
                ('updated_at', models.DateTimeField(auto_now=True, verbose_name='Dernière mise à jour')),
                ...
                ('invited_client', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='invitation', to='play_reports.client', verbose_name='Client invité')),
        ...
        migrations.AddConstraint(
            model_name='client',
            constraint=models.UniqueConstraint(condition=models.Q(('tenant', None), _negated=True), fields=('user', 'tenant'), name='unique_user_tenant'),
        ),
    ]
